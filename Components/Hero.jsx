...
const Hero = ({ titleData, createCampaign }) => {
  const [campaign, setCampaign] = useState({
    title: "", // Fixed typo "tite" to "title"
    description: "",
    amount: "",
    deadline: "",
  });
  ...
  return (
    <div className="relative">
      <span className="coverLine"></span> {/* Fixed unclosed tag */}
      <Image
        src="" // Provide a valid image source
        ...
        md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              ...
              text-white sm:text-5xl sm:leading-none"> {/* Fixed "leading-none" class */}
              ...
              <a
                ...
                hover:text-teal-accent-700 text-gray-200" // Removed space after hover:
              >
                Learn more
                <svg
                  className="inline-block w-3 ml-2"
                  fill="currentColor" // Fixed "currentColor" typo
                  viewBox="0 0 12 12"
                >
            ...
            <div className="w-full max-w-xl xl:px-8 xl:w-5/12">
              <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                ...
                sm:text-2xl"> {/* Fixed unclosed tag */}
                  Create Campaign
                </h3>
                <form>
                  <div className="mb-1 sm:mb-2">
                    ...
                    <input
                      ...
                      id="title" // Updated ID to match the label
                  ...
                  <div className="mb-1 sm:mb-2">
                    <label
                      htmlFor="description"
                      className="inline-block mb-1 font-medium" // Fixed "inline-block" typo
                    >
                      Description
                    </label>
                    <input
                  ...
                  <div className="mb-1 sm:mb-2">
                    ...
                    <input
                      onChange={(e) =>
                        setCampaign({
                          ...campaign,
                          amount: e.target.value, // Updated to match state property
                        })
                      }
                  ...
                  <p className="text-xs text-gray-600 sm:text-sm"> {/* Fixed typo "text-gray-600" */}
